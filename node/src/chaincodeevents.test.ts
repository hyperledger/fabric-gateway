...
function assertChaincodeEventRequest(request:ChaincodeEventsRequestProto,channelName:string,chaincodeName:string,typeCase: SeekPosition.TypeCase ,blockNumber?:bigint, transactionId?:string) {
