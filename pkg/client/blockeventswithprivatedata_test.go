...
func TestBlockAndPrivateDataEvents(t *testing.T) {
	t.Run("Returns connect error", func(t *testing.T) {
		...
		ExpectDeliverWithPrivateData(mockConnection, WithNewStreamError(expected))
	...
	for testName, testCase := range map[string]struct {
		...
		t.Run(testName, func(t *testing.T) {
			...
			ExpectDeliverWithPrivateData(mockConnection, WithNewStreamResult(mockStream))
			...
			network := AssertNewTestNetwork(t, "NETWORK", WithClientConnection(mockConnection))
			_, err := network.BlockAndPrivateDataEvents(ctx, testCase.options...)
	...
	t.Run("Uses specified gRPC call options", func(t *testing.T) {
		...
		ExpectDeliverWithPrivateData(mockConnection, CaptureNewStreamOptions(options), WithNewStreamResult(mockStream))
