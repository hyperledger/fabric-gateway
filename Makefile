...
fabric_protos_commit = f44816d6f621f1f7615cb4fc65643791eb6d8ce6
pb_files = protos/gateway.pb.go protos/gateway_grpc.pb.go
...
$(pb_files): fabric-protos protos/gateway.proto
	protoc --version
	protoc -I./protos -I./fabric-protos --go_out=paths=source_relative:./protos --go-grpc_out=require_unimplemented_servers=false,paths=source_relative:./protos protos/gateway.proto
