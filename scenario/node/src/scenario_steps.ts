...
Then(
    ...
    async function (this: CustomWorld, eventName: string, payload: string): Promise<void> {
...
Then(
    ...
    async function (this: CustomWorld, eventName: string, payload: string, listenerName: string): Promise<void> {
