...
public final class GatewayMocker implements AutoCloseable {
    ...
    public ChaincodeSpec getChaincodeSpec(SignedProposal proposedTransaction) throws InvalidProtocolBufferException {
        Proposal proposal = getProposal(proposedTransaction);
    ...
    public Proposal getProposal(SignedProposal proposedTransaction) throws InvalidProtocolBufferException {
        return Proposal.parseFrom(proposedTransaction.getProposalBytes());
    }
